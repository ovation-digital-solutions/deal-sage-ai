      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
        ...
        <div className="bg-white rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 lg:p-6">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600">Market Updates</p>
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{dashboardData.stats.marketUpdates}</p>
            </div>
          </div>
        </div>
